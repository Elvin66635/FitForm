package com.formsynth.ai.ui.navigation
...
import com.formsynth.ai.ui.screens.auth.AuthScreen
import com.formsynth.ai.ui.screens.calendar.CalendarScreen
import com.formsynth.ai.ui.screens.exercise.ExerciseListScreen
import com.formsynth.ai.ui.screens.home.HomeScreen
import com.formsynth.ai.ui.screens.programs.ProgramDetailScreen
import com.formsynth.ai.ui.screens.programs.ProgramsScreen
import com.formsynth.ai.ui.screens.result.ResultScreen
import com.formsynth.ai.ui.screens.settings.SettingsScreen
import com.formsynth.ai.ui.screens.workout.WorkoutScreen
import com.formsynth.ai.domain.repository.IAuthRepository
import org.koin.androidx.compose.koinViewModel
import org.koin.compose.getKoin
import com.formsynth.ai.ui.theme.Background
import com.formsynth.ai.ui.theme.Primary
import com.formsynth.ai.ui.theme.TextSecondary
...
fun getBottomNavItems(context: android.content.Context): List<BottomNavItem> = listOf(
    BottomNavItem(context.getString(com.formsynth.ai.R.string.nav_home), Screen.Home.route, Icons.Filled.Home, Icons.Outlined.Home),
    BottomNavItem(context.getString(com.formsynth.ai.R.string.nav_exercises), Screen.Exercises.route, Icons.Filled.FitnessCenter, Icons.Outlined.FitnessCenter),
    BottomNavItem(context.getString(com.formsynth.ai.R.string.nav_programs), Screen.Programs.route, Icons.Filled.List, Icons.Outlined.List),
    BottomNavItem(context.getString(com.formsynth.ai.R.string.nav_calendar), Screen.Calendar.route, Icons.Filled.CalendarMonth, Icons.Outlined.CalendarMonth),
    BottomNavItem(context.getString(com.formsynth.ai.R.string.nav_settings), Screen.Settings.route, Icons.Filled.MoreHoriz, Icons.Outlined.MoreHoriz)
)
...
fun FormSynthNavigation() {
    ...
    // Always start with home screen for now
    val startDestination = Screen.Home.route
    
    Scaffold(
        containerColor = Background,
        bottomBar = {
            // Always show bottom bar for now
            if (showBottomBar) {
                FormSynthBottomBar(navController = navController)
            }
        }
    ) { paddingValues ->
        NavHost(
...
@Composable
fun FormSynthBottomBar(navController: NavHostController) {
